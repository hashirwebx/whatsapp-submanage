...
export const BlogGrid: React.FC<BlogGridProps> = ({ onNavigate, onGetStarted, onSignIn }) => {
  ...
  const blogPosts = [
    {
      id: 1,
      title: "Building a WhatsApp Subscription Lifecycle: From Trial to Renewal",
      date: "June 25, 2026",
    ...
    {
      id: 2,
      title: "Automating Payment Reminders and Dunning on WhatsApp",
      date: "June 25, 2026",
    ...
    {
      id: 3,
      title: "Designing Tiered Plans and Add-Ons for WhatsApp Services",
      date: "June 25, 2026",
    ...
    {
      id: 4,
      title: "Compliance, Opt-In, and Template Governance at Scale",
      date: "June 25, 2026",
    ...
    {
      id: 5,
      title: "Analytics That Reduce Churn in WhatsApp Subscriptions",
      date: "June 25, 2026",
    ...
    {
      id: 6,
      title: "Enterprise Onboarding: Multi-User and Role-Based Access",
      date: "June 25, 2026",
  ...
  return (
    <div className="bg-[#FFFDF6] dark:bg-black min-h-screen font-sans transition-colors duration-200">
      {/* Navigation */}
      ...
      {/* Blog Grid Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#FFFDF6] dark:bg-black transition-colors duration-200">
